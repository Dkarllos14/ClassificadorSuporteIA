...
export default function HistoricoPage() {
  ...
  const metricas = useMemo(() => {
    ...
    const prioridadeAltaOuCritica = chamados.filter(
      (c) => c.prioridade === "ALTA" || c.prioridade === "CRITICA"
    ).length;

    const categoriaAcesso = chamados.filter(
      (c) => c.categoria === "ACESSO"
    ).length;
        ...
        <div className="mx-auto max-w-5xl">
          <div className="mb-6">
            ...
            <p className="mt-1 text-slate-600">
              Visualize os chamados processados pela IA.
            </p>
          </div>
                ...
                {chamados.map((chamado) => (
                  ...
                  >
                    ...
                    <div className="mt-4 flex flex-wrap gap-3 text-sm">
                      ...
                      <span
                        className={`rounded-full px-3 py-1 ${getPrioridadeClasses(
                          chamado.prioridade
                        )}`}
                      >
                        ⚡ {chamado.prioridade}
                      ...
                      <span
                        className={`rounded-full px-3 py-1 ${getImpactoClasses(
                          chamado.impacto
                        )}`}
                      >
                        📊 {chamado.impacto}
